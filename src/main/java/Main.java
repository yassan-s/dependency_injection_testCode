public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 請求結果を標準出力する
        Account account = new Account("ABC", new MoneyForward());
        ...
        System.out.println("DEFさんにはMisocaで請求書を送る");
        Account accountForYamada = new Account("DEF", new Misoca());
        String defClosingResult = accountForYamada.closing(300000);
        System.out.println("山田さんへの請求結果：" + defClosingResult);
    }
}
